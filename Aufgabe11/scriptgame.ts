 ...
 * Karten werden generiert
     * Kombinaton von "Zahl" und "Farbe", zugriff auf CSSDatei, jede Kombination nur einmal
     * Zahl num: 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020
     * Farbe colour: Luke (blau), Ashton (red), Calum (green), Michael (gelb)
*/
interface Card {
    colour: string[]; 
    num: number;
...
var colour: string[] = ["blue", "red", "green", "yellow"];
var num: number[] = [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020];
...
var ziehstapel: string [] = [];

/**Array für den Ablegestapel */
var ablegestapel: string [] = [];

/**Array für die Karten des Spielers */
var spielerhand: string [] = [];
